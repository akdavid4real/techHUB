// Course slider, catalog download, Udemy grid, Why us
...
function CourseSlider() {
  ...
  const dotCount = Math.ceil(total / Math.floor(visible));
...
Object.assign(window, { CourseSlider, Catalog, UdemyGrid, WhyUs });
